"use strict";class Deamon{objectUri=void 0;constructor(){}buildScript=()=>`self.onconnect = function(e) {
  ...
  self.onmessage = function(event) {
    ...
    self.postMessage((${r})())
    return close()
  }`;buildUri=r=>{const e=window.URL||window.webkitURL;r=new Blob([r],{type:"application/javascript"});this.objectUri=e.createObjectURL(r)};create=(r,e)=>{var t=this;t.objectUri||(r=this.buildScript(r),t.buildUri(r)),t.worker||(t.worker=new Worker(this.objectUri))};createDeamonWorker=t=>{const o=this;if(t&&0<t){const s=o.deamonWorker.getDeamonWorker();return new Promise((r,e)=>{s.port.onmessage=r=>{o.destroy(),e(r.data+". this worker is close")},s.port.postMessage([t]),console.log("deamonWorker timing start...")})}};destroy=()=>{if(this.worker&&(this.worker.terminate(),this.worker=void 0),"testUri"!==this.objectUri){const r=window.URL||window.webkitURL;r.revokeObjectURL(this.objectUri),this.objectUri=void 0}};run=(r,s)=>{var e=isValid(r)("function"),t=isValid(s)(["array","undefined"]);if(!e)return console.error(argumentError({expected:"a function",received:r})),null;if(!t)return console.error(argumentError({expected:"an array",received:s})),null;const i=this;return this.create(r),r=>{const o=this.createDeamonWorker(r);return new Promise((e,t)=>{o&&o.catch(t),i.worker.onmessage=r=>{i.destroy(),e(r.data)},i.worker.onerror=r=>{console.error(`Error: Line ${r.lineno} in ${r.filename}: `+r.message),t(r)},i.worker.postMessage({message:{args:s}})})}}}class WorkerBuilder{thread;constructor(){this.thread=class{constructor(){}run=()=>{console.error("This browser does not have the conditions for execution")}},window.Worker?window.SharedWorker?window.URL.createObjectURL||window.webkitURL.createObjectURL?this.thread=Thread:console.error("This browser does not have URL.createObjectURL method."):console.error("This browser does not support SharedWorker."):console.error("This browser does not support Workers.")}build=()=>this.thread}module.exports=WorkerBuilder;
//# sourceMappingURL=swwu.min.js.map
